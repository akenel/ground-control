...
**7. One driver.**
One session steers at a time. Orchestrate the work; don't juggle three terminals fighting each other. When two hands grab the wheel, you get a collision, not speed.
